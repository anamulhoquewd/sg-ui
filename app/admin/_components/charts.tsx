...
const revenueData = [
  { month: "Jan", revenue: 65000, orders: 220, profit: 32500, aov: 1200, conversion: 3.2 },
  { month: "Feb", revenue: 59000, orders: 195, profit: 29500, aov: 1150, conversion: 3.0 },
  { month: "Mar", revenue: 80000, orders: 265, profit: 40000, aov: 1300, conversion: 3.5 },
  { month: "Apr", revenue: 81000, orders: 270, profit: 40500, aov: 1350, conversion: 3.6 },
  { month: "May", revenue: 56000, orders: 190, profit: 28000, aov: 1100, conversion: 2.9 },
  { month: "Jun", revenue: 55000, orders: 185, profit: 27500, aov: 1050, conversion: 2.8 },
  { month: "Jul", revenue: 72000, orders: 240, profit: 36000, aov: 1250, conversion: 3.3 },
  { month: "Aug", revenue: 78000, orders: 260, profit: 39000, aov: 1280, conversion: 3.4 },
  { month: "Sep", revenue: 82000, orders: 275, profit: 41000, aov: 1320, conversion: 3.7 },
  { month: "Oct", revenue: 85000, orders: 280, profit: 42500, aov: 1350, conversion: 3.8 },
  { month: "Nov", revenue: 90000, orders: 300, profit: 45000, aov: 1400, conversion: 4.0 },
  { month: "Dec", revenue: 95000, orders: 320, profit: 47500, aov: 1450, conversion: 4.2 },
]
...
const productPerformanceData = [
  { name: "Himshagor", sales: 120, revenue: 42000, views: 2500, conversion: 4.8 },
  ...
  { name: "Pure Honey", sales: 150, revenue: 97500, views: 3000, conversion: 5.0 },
  { name: "Seasonal Pack", sales: 50, revenue: 60000, views: 1500, conversion: 3.3 },
]
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={revenueData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          ...
          <YAxis stroke={isDark ? "#e5e7eb" : "#374151"} tickFormatter={(value) => `৳${value / 1000}k`} />
          <ChartTooltip content={<ChartTooltipContent />} />
          <Legend />
          <Line type="monotone" dataKey="revenue" stroke="var(--color-revenue)" strokeWidth={2} activeDot={{ r: 6 }} />
          <Line type="monotone" dataKey="profit" stroke="var(--color-profit)" strokeWidth={2} activeDot={{ r: 6 }} />
        </LineChart>
      </ResponsiveContainer>
    </ChartContainer>
  )
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={revenueData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid strokeDasharray="3 3" stroke={isDark ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)"} />
          <XAxis dataKey="month" stroke={isDark ? "#e5e7eb" : "#374151"} />
          <YAxis stroke={isDark ? "#e5e7eb" : "#374151"} tickFormatter={(value) => `৳${value}`} />
          <ChartTooltip content={<ChartTooltipContent />} />
          <Legend />
          <Line type="monotone" dataKey="aov" stroke="var(--color-aov)" strokeWidth={2} activeDot={{ r: 6 }} />
        </LineChart>
      </ResponsiveContainer>
    </ChartContainer>
  )
...
export function SalesByLocationChart() {
  ...
  return (
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={salesByLocation} layout="vertical" margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid strokeDasharray="3 3" stroke={isDark ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)"} />
          <XAxis type="number" stroke={isDark ? "#e5e7eb" : "#374151"} tickFormatter={(value) => `${value}%`} />
          <YAxis dataKey="name" type="category" stroke={isDark ? "#e5e7eb" : "#374151"} />
          <ChartTooltip content={<ChartTooltipContent />} />
          <Legend />
...
export function SalesByTimeChart() {
  ...
  return (
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={salesByTime} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid strokeDasharray="3 3" stroke={isDark ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)"} />
...
export function UserAcquisitionChart() {
  ...
  return (
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={userAcquisitionData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid strokeDasharray="3 3" stroke={isDark ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)"} />
          <XAxis dataKey="month" stroke={isDark ? "#e5e7eb" : "#374151"} />
          <YAxis stroke={isDark ? "#e5e7eb" : "#374151"} />
          <ChartTooltip content={<ChartTooltipContent />} />
...
export function UserRetentionChart() {
  ...
  return (
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={userRetentionData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid strokeDasharray="3 3" stroke={isDark ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)"} />
          <XAxis dataKey="month" stroke={isDark ? "#e5e7eb" : "#374151"} />
          <YAxis stroke={isDark ? "#e5e7eb" : "#374151"} tickFormatter={(value) => `${value}%`} />
          <ChartTooltip content={<ChartTooltipContent />} />
...
export function UserDemographicsChart() {
  ...
  return (
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={userDemographicsData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid strokeDasharray="3 3" stroke={isDark ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)"} />
          ...
          <Bar dataKey="female" fill="var(--color-female)" radius={[0, 0, 0, 0]} />
          <Bar dataKey="other" fill="var(--color-other)" radius={[0, 4, 4, 0]} />
        </BarChart>
      </ResponsiveContainer>
    </ChartContainer>
  )
...
export function UserEngagementChart() {
  ...
  return (
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <ComposedChart data={userEngagementData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid strokeDasharray="3 3" stroke={isDark ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)"} />
          <XAxis dataKey="month" stroke={isDark ? "#e5e7eb" : "#374151"} />
          <YAxis yAxisId="left" orientation="left" stroke={isDark ? "#e5e7eb" : "#374151"} />
          <YAxis yAxisId="right" orientation="right" stroke={isDark ? "#e5e7eb" : "#374151"} />
          <ChartTooltip content={<ChartTooltipContent />} />
          <Legend />
          <Bar yAxisId="left" dataKey="pageViews" fill="var(--color-pageViews)" radius={[4, 4, 0, 0]} />
          <Line yAxisId="left" type="monotone" dataKey="timeOnSite" stroke="var(--color-timeOnSite)" />
          <Line yAxisId="right" type="monotone" dataKey="bounceRate" stroke="var(--color-bounceRate)" />
        </ComposedChart>
      </ResponsiveContainer>
    </ChartContainer>
  )
...
export function UserLocationChart() {
  ...
  return (
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={userLocationData} layout="vertical" margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid strokeDasharray="3 3" stroke={isDark ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)"} />
          <XAxis type="number" stroke={isDark ? "#e5e7eb" : "#374151"} tickFormatter={(value) => `${value}%`} />
          <YAxis dataKey="name" type="category" stroke={isDark ? "#e5e7eb" : "#374151"} />
          <ChartTooltip content={<ChartTooltipContent />} />
...
export function UserLifetimeValueChart() {
  ...
  return (
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={userLifetimeValueData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid strokeDasharray="3 3" stroke={isDark ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)"} />
          <XAxis
            dataKey="month"
          ...
          <ChartTooltip content={<ChartTooltipContent />} />
          <Legend />
          <Line type="monotone" dataKey="value" stroke="var(--color-value)" strokeWidth={2} activeDot={{ r: 6 }} />
        </LineChart>
      </ResponsiveContainer>
    </ChartContainer>
  )
...
export function UserSessionsChart() {
  ...
  return (
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={userSessionsData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid strokeDasharray="3 3" stroke={isDark ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)"} />
...
export function ProductSalesChart() {
  ...
  return (
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={productPerformanceData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }} layout="vertical">
          <CartesianGrid strokeDasharray="3 3" stroke={isDark ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)"} />
          <XAxis type="number" stroke={isDark ? "#e5e7eb" : "#374151"} />
          <YAxis dataKey="name" type="category" stroke={isDark ? "#e5e7eb" : "#374151"} />
          <ChartTooltip content={<ChartTooltipContent />} />
          <Legend />
          <Bar dataKey="sales" fill="var(--color-sales)" radius={[0, 0, 0, 0]} />
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={productPerformanceData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }} layout="vertical">
          ...
          <ChartTooltip content={<ChartTooltipContent />} />
          <Legend />
          <Bar dataKey="conversion" fill="var(--color-conversion)" radius={[0, 4, 4, 0]} />
        </BarChart>
      </ResponsiveContainer>
    </ChartContainer>
  )
...
export function ProductReviewsChart() {
  ...
  return (
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <ComposedChart data={productReviewsData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }} layout="vertical">
          <CartesianGrid strokeDasharray="3 3" stroke={isDark ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)"} />
          <XAxis type="number" stroke={isDark ? "#e5e7eb" : "#374151"} />
          <YAxis dataKey="name" type="category" stroke={isDark ? "#e5e7eb" : "#374151"} />
          <ChartTooltip content={<ChartTooltipContent />} />
          <Legend />
          <Bar dataKey="reviews" fill="var(--color-reviews)" radius={[0, 4, 4, 0]} />
...
export function ProductCategoryPerformanceChart() {
  ...
  return (
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={productCategoryPerformanceData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid strokeDasharray="3 3" stroke={isDark ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)"} />
          <XAxis dataKey="category" stroke={isDark ? "#e5e7eb" : "#374151"} />
          <YAxis stroke={isDark ? "#e5e7eb" : "#374151"} />
          <ChartTooltip content={<ChartTooltipContent />} />
          <Legend />
          <Bar dataKey="sales" fill="var(--color-sales)" radius={[4, 0, 0, 4]} />
...
export function ProductInventoryChart() {
  ...
  return (
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={productInventoryData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }} layout="vertical">
          <CartesianGrid strokeDasharray="3 3" stroke={isDark ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)"} />
          <XAxis type="number" stroke={isDark ? "#e5e7eb" : "#374151"} />
          <YAxis dataKey="name" type="category" stroke={isDark ? "#e5e7eb" : "#374151"} />
          <ChartTooltip content={<ChartTooltipContent />} />
          ...
          <Bar dataKey="reorderPoint" fill="var(--color-reorderPoint)" radius={[0, 4, 4, 0]} />
        </BarChart>
      </ResponsiveContainer>
    </ChartContainer>
  )
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <ScatterChart margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          ...
          />
          <ChartTooltip content={<ChartTooltipContent />} />
          <Scatter name="Price vs Sales" data={productPriceImpactData} fill="var(--color-sales)" />
        </ScatterChart>
      </ResponsiveContainer>
    </ChartContainer>
  )
...
export function ProductSeasonalityChart() {
  ...
  return (
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={productSeasonalityData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid strokeDasharray="3 3" stroke={isDark ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)"} />
          <XAxis dataKey="month" stroke={isDark ? "#e5e7eb" : "#374151"} />
          <YAxis stroke={isDark ? "#e5e7eb" : "#374151"} />
          <ChartTooltip content={<ChartTooltipContent />} />
          <Legend />
          <Line type="monotone" dataKey="mangoes" stroke="var(--color-mangoes)" strokeWidth={2} activeDot={{ r: 6 }} />
          <Line type="monotone" dataKey="honey" stroke="var(--color-honey)" strokeWidth={2} activeDot={{ r: 6 }} />
        </LineChart>
      </ResponsiveContainer>
    </ChartContainer>
  )
